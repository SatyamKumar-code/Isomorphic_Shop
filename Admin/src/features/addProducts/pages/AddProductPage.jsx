...
const AddProductPage = () => {
    ...
    return (
        <div className="w-full min-h-[calc(100vh-96px)] px-5 pb-6 pt-4">
            {!isSellerApproved ? (
                <div className="mb-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-900/40 dark:bg-amber-950/20 dark:text-amber-200">
                    Your seller account is waiting for admin approval. You can complete your profile, but product creation is disabled until approval.
                </div>
            ) : null}
