    ...
    return (
        <div className='ml-5 my-4 p-5 gap-2 w-97.5 h-55.5 shadow-md inset-shadow-sm inset-shadow-gray-300 shadow-gray-300 dark:shadow-gray-700 dark:inset-shadow-gray-700 bg-white dark:bg-gray-950 rounded-lg'>
            <div className='w-full min-h-6.5 flex items-center justify-between'>
                <h1 className='text-[#23272E] dark:text-[#c1c6cf] font-bold text-[18px] font-lato'>Total Sales</h1>
            ...
            <div className='min-w-[208px] min-h-[38px] flex items-center gap-4'>
                <h2 className='text-[#23272E] dark:text-[#c1c6cf] font-bold text-[32px] leading-normal font-lato'> $350K </h2>
                <div className='min-w-[95px] min-h-[19px] flex gap-1 '>
                    <p className='text-[#000000] dark:text-[#c1c6cf] text-[14px] leading-normal tracking-[-0.02em] font-lato flex items-center gap-1 '>Sales</p>
                    <p className='text-[#21C45D] text-[14px] leading-normal tracking-[-0.02em] font-lato flex items-center gap-1 '><FaArrowUp />10.4%</p>
                </div>
            </div>

            <p className='text-[#6A717F] text-[14px] leading-normal tracking-normal font-lato'>Previous 7days <span className='text-[#6467F2]'>($235)</span></p>
