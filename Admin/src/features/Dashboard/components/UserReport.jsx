...
const UserReport = () => {
    return (
        <div className='w-96.5 h-115 ml-5 p-5 shadow-md inset-shadow-sm inset-shadow-gray-300 shadow-gray-300 dark:shadow-gray-700 dark:inset-shadow-gray-700 bg-white dark:bg-gray-950 rounded-lg'>
            <div className='w-full h-14.25 flex justify-between'>
                <div className='max-w-35.25 min-h-14.25 '>
                    <span className='text-[#6467F2] text-[14px] tracking-[-0.02em]'>User in last 30 minutes</span>
                    <h2 className='text-[32px] font-bold text-[#333] dark:text-white mt-2 tracking-[-0.02em] leading-8'>21.5K</h2>
                </div>
            ...
            <p className='text-[14px] tracking-[-0.02em] font-medium text-[#6A717F] mt-6.25 mb-3'>Users per minute</p>
            ...
            <div className='space-y-3 mb-6'>
                ...
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-2'>
                        {/* US Flag */}
                        <span className='w-7 h-7 rounded-full overflow-hidden flex items-center justify-center border border-gray-200'>
                            <img src='https://flagcdn.com/us.svg' alt='US' className='w-6 h-6' />
                        </span>
                ...
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-2'>
                        {/* Brazil Flag */}
                        <span className='w-7 h-7 rounded-full overflow-hidden flex items-center justify-center border border-gray-200'>
                            <img src='https://flagcdn.com/br.svg' alt='Brazil' className='w-6 h-6' />
                        </span>
                ...
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-2'>
                        {/* Australia Flag */}
                        <span className='w-7 h-7 rounded-full overflow-hidden flex items-center justify-center border border-gray-200'>
                            <img src='https://flagcdn.com/au.svg' alt='Australia' className='w-6 h-6' />
                        </span>
