...
const SummaryCard = ({ card }) => {
    return (
        <div className="relative rounded-lg bg-white p-4 shadow-md inset-shadow-sm inset-shadow-gray-300 shadow-gray-300 dark:bg-gray-950 dark:shadow-gray-700 dark:inset-shadow-gray-700">
...
const ReviewSummaryCards = () => {
    const { summaryCards } = useProductReviews();
