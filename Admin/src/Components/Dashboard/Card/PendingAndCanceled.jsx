    ...
    return (
        <div className='ml-5 my-4 p-5 gap-2 w-97.5 h-55.5 shadow-md inset-shadow-sm inset-shadow-gray-300 shadow-gray-300 dark:shadow-gray-700 dark:inset-shadow-gray-700 bg-white dark:bg-gray-950 rounded-lg'>
            <div className='w-full min-h-6.5 flex items-center justify-between'>
                <h1 className='text-[#23272E] dark:text-[#c1c6cf] font-bold text-[18px] font-lato'>Pending & Canceled</h1>
            ...
            <div className='flex w-full items-center gap-4'>
                <div className='w-[50%] gap-1.75'>
                    ...
                    <div className='min-w-27.25 min-h-6.5 flex gap-[3.5px] '>
                        <h2 className='text-[#23272E] dark:text-[#c1c6cf] font-bold text-[22px] leading-normal font-lato'>509</h2>
                        <p className='text-[#21C45D] text-[14px] leading-normal tracking-[-0.02em] font-lato flex items-center gap-1 '>user 204</p>
                    </div>
                </div>
                ...
                <div className='w-[50%] gap-1.75'>
                    ...
                    <div className='min-w-27.25 min-h-6.5 flex gap-2 '>
                        <h2 className='text-[#EF4343] dark:text-[#c1c6cf] font-bold text-[22px] leading-normal font-lato'>94</h2>
                        <p className='text-[#F87272] text-[14px] leading-normal tracking-[-0.02em] font-lato flex items-center gap-1 '><FaArrowDown />14.4%</p>
                    </div>
                </div>
            </div>
